...
posterior_fit$Environment <- c("Benign_Male", "Benign_Both", "Benign_Female", "Stressful_Male", "Stressful_Both", "Stressful_Female")
...
posterior_fit %>% ggplot(aes(x=value, y = Environment, fill = Sex))+
