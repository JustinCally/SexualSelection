...
```{r, warning=FALSE, message=FALSE, error = FALSE, fig.align='center', fig.width = 10}
...
*Fourthly*, Hedges' g appears more normally distributed than lnRR, which to some extent may come as a surprise as **some literature** says lnRR should usually be more normal. A normal distribution of the response variable is anticipated to increase model fit.
...
However, when using lnVR, the variability of fitness traits for males under sexual selection increased, lnVR for females in stressful environments was not statistically different from zero, and sexual selection in benign environments increased phenotypic variance for females.  
