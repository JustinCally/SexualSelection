...
Many thanks for your time, and for the very helpful comments on our manuscript. We have considerably reworked the manuscript in light of the many insightful comments and suggestions provided by the reviewers. Please see below for a detailed list of responses to each of the reviewers' points. 
...
Finally, in addition to the changes suggested by reviewers, we discovered a small number of errors in our original analysis, related to how effect sizes were calculated from certain primary studies in our meta-analysis. As such, we have thoroughly rechecked our dataset and re-ran the analyses with all errors corrected. **XXXXXXXXX**
...
Thank you for catching this -- we have tempered our conclusions in the relevant section of the Discussion, since the results provide only moderate evidence for a positive effect of sexual selection on these traits.
...
This information could be found in the supplementary material in the section *Meta-analyses including many moderator variables* as well as in Figure S12 and S13. Generations (specifically, log-Generations) had minimal effect on the effect sizes and so was removed for the "minimum adequate models" that we presented in the main text. **We now clarify this in the main text JUSTIN, MAYBE REFERENCE THOSE FIGURES WHEN SAYING IT'S NON-SIG OR SOMETHING LIKE THAT**.
...
Our supplementary material does indeed contain all of our main figures, in order to show the data and code used to generate them. We have now made sure that e.g. Figure 2 in the HTML supplement is correctly labelled as Figure 2, to make it clear that it is not a different figure. **A JOB FOR JUSTIN HERE**
...
We think that the scope of a true systematic review (in the sense used by e.g. Cochrane reviews) is larger than our study entails. However, we did use a systematic literature search strategy and PRISMA framework of inclusion/exclusion. With this in mind, we have left our paper's title as "meta-analysis" rather than calling it a systematic review.
