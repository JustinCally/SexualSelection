...
subtitle: Response to Editorial Requests and Reviewer 1
...
\begin{enumerate}
  ...
  We only use italics for latin words or abbreviations (\textit{e.g., i.e., Prima facie}) and not for emphasis.  
...
\begin{enumerate}
  ...
  We have modified the title and abstract of the paper, and made it clear which conclusions are supported unambiguously and which are more tentative. For example…. [provide a quote or two].
